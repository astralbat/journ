...
pub struct BalCommand {
    ...
    /// A set of codes to convert amounts to.
...
impl BalCommand {
    ...
    pub fn set_value_units(&mut self, value_units: Vec<String>) {
    ...
    /*
    pub fn exchange_currency(&self) -> Option<&'t Unit<'t>> {
        self.exchange_currency
    }

    pub fn set_exchange_currency(&mut self, exchange_currency: Option<&'t Unit<'t>>) {
